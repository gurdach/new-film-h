!function(e) {
    ...
    "+Hwo": function(e, t, n) {
        ...
        function b(e) {
            ...
            if ("tv_series" === a) {
                var n = document.getElementById("season").value
                  , r = document.getElementById("episode").value;
                if (n) {
                    var i = n;
                    r && (i += "_" + r),
                    t.api("find", i),
        ...
        window.PlayerjsEvents = function(e, t, n) {
            "vast_Impression" === e && w.finish(h, v),
            console.log(e, t, n)
        }
        ,
        (0,
    ...
    "7t+N": function(e, t, n) {
        ...
        !function(t, n) {
            ...
            var S = function(e) {
                var t, n, r, i, o, a, s, u, l, c, f, d, p, h, g, v, m, y, x, b = "sizzle" + 1 * new Date, w = e.document, C = 0, T = 0, E = ue(), k = ue(), S = ue(), j = ue(), N = function(e, t) {
                    return e === t && (f = !0),
                    0
                    ...
                    for (var n = 0, r = e.length; n < r; n++)
                        if (e[n] === t)
                            return n;
                    return -1
                }, I = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", B = "\\[" + M + "*(" + R + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + M + "*\\]", _ = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + B + ")*)|.*)\\)|)", W = new RegExp(M + "+","g"), F = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), $ = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), U = new RegExp(M + "|>"), X = new RegExp(_), V = new RegExp("^" + R + "$"), Q = {
                    ID: new RegExp("^#(" + R + ")"),
                    CLASS: new RegExp("^\\.(" + R + ")"),
                    TAG: new RegExp("^(" + R + "|[*])"),
                    ATTR: new RegExp("^" + B),
                ...
                }, Y = /HTML$/i, G = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)","ig"), ne = function(e, t, n) {
                    var r = "0x" + t - 65536;
                ...
                function se(e, t, r, i) {
                    ...
                    g)) {
                        ...
                        if (n.qsa && !j[e + " "] && (!v || !v.test(e)) && (1 !== C || "object" !== t.nodeName.toLowerCase())) {
                            if (m = e,
                            y = t,
                            1 === C && U.test(e)) {
            ...
            T.extend({
                ...
                ready: function(e) {
                    ...
                    !0 !== e && --T.readyWait > 0 || $.resolveWith(a, [T]))
                }
            }),
            T.ready.then = $.then,
            ...
            T.event = {
                ...
                special: {
                    ...
                    click: {
                        setup: function(e) {
                            var t = this || e;
                            return ge.test(t.type) && t.click && D(t, "input") && Le(t, "click", Ne),
                            !1
                        },
                        trigger: function(e) {
                            var t = this || e;
            ...
            T.Event = function(e, t) {
                ...
                this.type = e.type,
                this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ne : Ae,
            ...
            function We(e, t, n, r) {
                ...
                o || r)) {
                    for (s = (a = T.map(xe(i, "script"), Re)).length; f < d; f++)
                        u = i,
                        f !== p && (u = T.clone(u, !0, !0),
            ...
            function Xe(e, t, n) {
                ...
                !m.pixelBoxStyles() && $e.test(a) && Ue.test(t) && (r = s.width,
                i = s.minWidth,
                o = s.maxWidth,
            ...
            T.cssHooks.marginLeft = Ve(m.reliableMarginLeft, function(e, t) {
                if (t)
                    return (parseFloat(Xe(e, "marginLeft")) || e.getBoundingClientRect().left - ce(e, {
                        marginLeft: 0
                    }, function() {
            ...
            T.extend(T.event, {
                trigger: function(e, t, r, i) {
                    ...
                    i || !d.trigger || !1 !== d.trigger.apply(r, t))) {
                        ...
                        return e.type = v,
                        i || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(g.pop(), t) || !G(r) || c && y(r[v]) && !x(r) && ((u = r[c]) && (r[c] = null),
                        T.event.triggered = v,
            ...
            T.extend({
                ...
                ajax: function(e, t) {
                    ...
                    if (m.promise(E),
                    h.url = ((e || h.url || kt.href) + "").replace(Rt, kt.protocol + "//"),
            ...
            T.ajaxPrefilter("json jsonp", function(e, t, r) {
                ...
                if (s || "jsonp" === e.dataTypes[0])
                    ...
                    s ? e[s] = e[s].replace(Gt, "$1" + i) : !1 !== e.jsonp && (e.url += (jt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
            ...
            m.createHTMLDocument = ((Qt = a.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
